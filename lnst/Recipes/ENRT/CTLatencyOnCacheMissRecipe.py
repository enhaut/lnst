...
from lnst.Recipes.ENRT.MeasurementGenerators.LatencyMeasurementGenerator import LatencyMeasurementGenerator
...
class CTLatencyOnCacheMissRecipe(LatencyMeasurementGenerator, LongLivedConnectionsMixin, CTInsertionRateNftablesRecipe):
    ...
    def generate_perf_configurations(self, config):
        ...
        return super(LongLivedConnectionsMixin, self).generate_perf_configurations(config)
