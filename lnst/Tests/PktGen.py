...
class PktGenResultsParser:
    ...
    def parse_dev_outputs(self) -> dict[str, list[dict[str, Union[float, int, dict]]]]:
        for thread in self._sampling_threads:
...
class PktGen(BaseTestModule):
    ...
    def run(self):
        ...
        output_parser = PktGenResultsParser(self._devices, self.params.duration)
        ...
        self._res_data = output_parser.parse_dev_outputs()
